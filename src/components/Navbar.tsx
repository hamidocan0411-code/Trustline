...
export function Navbar({
  ...
  const handleLogout = async () => {
    ...
    try {
      /*
       * Kurye çıkış yapmadan önce:
       * 1. Canlı GPS paylaşımını kapat
       * 2. Kurye durumunu Çevrimdışı yap
       * 3. Firebase Auth oturumunu kapat
       */
      if (currentUser.role === 'courier') {
        try {
          ...
          console.warn(
            '⚠️ Kurye çıkışında canlı konum kapatılamadı:',
            error
          );
        }
      }
