        ...
        {isRegister && (
          <div>
            ...
            <input
              ...
              autoComplete="name"
              disabled={loading}
              className="w-full h-12 rounded-xl bg-[#222229] border border-[#303036] px-4 text-sm text-white placeholder:text-[#555555] outline-none focus:border-[#D6A84F] transition disabled:opacity-50"
            />
          </div>
        )}
        {/* PHONE */}
